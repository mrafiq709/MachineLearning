...
public class PriceEstimator extends ApplicationFrame {
	...
	public static void main(String[] args) throws IOException {
		...
		double regressionParameters[] = Regression.getOLSRegression(demo.inputData, 0);
		double x = 200.0;
		...
		System.out.println("For 200.0 Living Area\nEstimated Price: " + y);
	...
	private JFreeChart createChart(XYDataset inputData) throws IOException {
		...
		JFreeChart chart = ChartFactory.createScatterPlot("Price for living area", "Price", "Living area", inputData,
