...
public class LogisticRegressionDemo {
	...
	public static final String TRAINING_DATA_SET_FILENAME = "training_data.arff";
	public static final String TESTING_DATA_SET_FILENAME = "testing_data.arff";
	...
	public static Instances getDataSet(String fileName) throws IOException {
		...
		// loader.setSource(LogisticRegressionDemo.class.getResourceAsStream("/"
		// + fileName));
		loader.setFile(new File(fileName));
		/**
